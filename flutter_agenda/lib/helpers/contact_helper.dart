...
class ContactHelper{
  ...
  Future<List> getAllContacts() async {
    Database dbContext = await db;
    List listMaps = await dbContext.rawQuery("SELECT * FROM $contactTable");
  ...
  Future<int> getNumber() async{
    Database dbContext = await db;
    return Sqflite.firstIntValue(await dbContext.rawQuery("SELECT COUNT(*) FROM $contactTable"));
  }
